...
var Cliente = exports["default"] = /*#__PURE__*/function () {
  ...
  return _createClass(Cliente, [{
    ...
    set: function set(data) {
      _classPrivateFieldSet(_nombre, this, data);
    }
  }, {
    key: "calcularImpuesto",
    value: function calcularImpuesto() {
      return "El impuesto final a pagar del cliente ".concat(_classPrivateFieldGet(_nombre, this), " es de: ").concat((this.impuesto.montoBrutoAnual - this.impuesto.deducciones) * 0.21);
    }
  }]);
}();